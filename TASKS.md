...
- [x] G1.1 Add shared school, organization, teacher, and student models
- [x] G1.1 Migrate AdminDataProvider and current-view adapters
- [x] G1.2 Add validated school and organization actions
- [x] G1.2 Add teacher reference checks and student enrollment actions
- [x] G1.3 Add fixed CSV/XLSX templates and import preview
- [x] G1.3 Add version validation and atomic import commit
