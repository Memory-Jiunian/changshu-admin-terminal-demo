...
function cloneFilters(filters: AdvancedFilterValues): AdvancedFilterValues {
  return {
    ...
    evidenceTypes: [...filters.evidenceTypes],
...
export function AdvancedFilterDialog({
  ...
  const categories = useMemo<FilterCategory[]>(
    () => [
      ...
      {
        key: "evidenceTypes",
        label: categoryLabels.evidenceTypes,
        options: [
          { label: warningEvidenceTypeLabels.teacher_report, value: "teacher_report" },
          { label: warningEvidenceTypeLabels.ai_chat, value: "ai_chat" },
          { label: warningEvidenceTypeLabels.deep_assessment, value: "deep_assessment" },
        ],
      },
      {
